...
class Order
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=OrderDetails::class, mappedBy="myOrder",cascade={"remove"}, orphanRemoval=true)
     */
    private $orderDetails;

    /**
     * @ORM\Column(type="text", options={"default" : "En cours"})
     */
    private $isPaid;
